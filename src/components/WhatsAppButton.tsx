...
const WhatsAppButton: React.FC = () => {
  ...
  return (
    <div className="fixed bottom-6 right-6 z-50 transition-all duration-400">
      <a 
        href="https://wa.me/41995870005" 
        target="_blank" 
        rel="noopener noreferrer" 
        className="flex items-center justify-center w-16 h-16 rounded-full bg-green-500 text-white shadow-lg transition-transform hover:scale-110 animate-bounce"
